...
enum SettingKeyEnum: string
{
    ...
    case CONTACT_US_TELEGRAM_LINK = 'contact_us_telegram_link';
    case CONTACT_US_WHATSAPP_LINK = 'contact_us_whatsapp_link';
    case CONTACT_US_EITAA_LINK = 'contact_us_eitaa_link';
    case CONTACT_US_HEAD_OFFICE_ADDRESS = 'contact_us_head_office_address';
    case CONTACT_US_FACTORY_ADDRESS = 'contact_us_factory_address';
