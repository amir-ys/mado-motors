...
use App\Services\Notification\SendSmsToAdmins;
...
class RequestRepository implements RequestRepositoryInterface
{
    ...
    public function store( $data ): Model|Builder
    {
        ...
        (new SendSmsToAdmins())->sendRequestNotification($data["device_title"], User::findOrFail($data["user_id"]));
    ...
    public function storeMyRequest( $data ): Model|Builder
    {
        ...
        (new SendSmsToAdmins())->sendRequestNotification($data["device_title"], auth()->user());
