...
class UpdateProductReview extends Controller
{
    ...
    public function __invoke($id, StoreProductReviewRequest $productReviewRequest): JsonResponse
    {
        ...
        return ApiResponse::success(
            ProductReviewResource::make(
                app(ProductReviewRepositoryInterface::class)->update(
                    $data,
                    $id,
                )
            )
